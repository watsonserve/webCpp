...
def makeout(src_file):
    a_relation = filt_file_type(src_file)
...
class Makefile:
    def __init__(self, prefix = '', framework = '', dirTree = {}):
...
def main():
    ...
    makefile = Makefile('', './framework', distDir)
